...
#pragma region InitVulkan()
    ...
    {
        auto computeShaderCode = readFile("shaders/shader_comp.spv");
...
#pragma region Input Processing
    ...
    void processInput() 
    {
        ...
        // Pressionar '1' para mudar para game
...
#pragma region MainLoop()
    ...
    void mainLoop() 
    {
        ...
        // Se foi pressionado '1', executar game
        if (switchToGame) {
            std::cout << "Mudando para Game..." << std::endl;
...
#pragma region Main Compute Function
